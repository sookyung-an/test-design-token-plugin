...
/* harmony import */ var _config_commands__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @config/commands */ "./src/config/commands.ts");
/* harmony import */ var _utils_getVersionDifference__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @utils/getVersionDifference */ "./src/utilities/getVersionDifference.ts");
/* harmony import */ var _utils_getFileId__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @utils/getFileId */ "./src/utilities/getFileId.ts");
/* harmony import */ var _utils_getTokenJson__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @utils/getTokenJson */ "./src/utilities/getTokenJson.ts");
/* harmony import */ var _utils_stringifyJson__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @utils/stringifyJson */ "./src/utilities/stringifyJson.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const openUi = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const versionDifference = yield (0,_utils_getVersionDifference__WEBPACK_IMPORTED_MODULE_3__["default"])(figma);
    // resize UI if needed
    // figma.ui.resize(
    ...
    const postMessageObject = {
        ...
        payload: {
            settings: Object.assign(Object.assign({}, userSettings), { accessToken: yield (0,_utils_accessToken__WEBPACK_IMPORTED_MODULE_1__.getAccessToken)((0,_utils_getFileId__WEBPACK_IMPORTED_MODULE_4__["default"])(figma)) }),
            data: null,
    ...
    if ([_config_commands__WEBPACK_IMPORTED_MODULE_2__.commands["export"], _config_commands__WEBPACK_IMPORTED_MODULE_2__.commands.urlExport].includes(figma.command)) {
        postMessageObject.payload.data = (0,_utils_stringifyJson__WEBPACK_IMPORTED_MODULE_6__.stringifyJson)(yield (0,_utils_getTokenJson__WEBPACK_IMPORTED_MODULE_5__.exportRawTokenArray)(figma, userSettings));
    }
